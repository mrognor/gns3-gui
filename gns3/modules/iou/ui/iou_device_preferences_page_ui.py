...
class Ui_IOUDevicePreferencesPageWidget(object):
    def setupUi(self, IOUDevicePreferencesPageWidget):
        ...
        self.uiIOUDeviceInfoTreeWidget = QtWidgets.QTreeWidget(parent=self.widget)
        ...
        self.uiNewIOUDevicePushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiCopyIOUDevicePushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiEditIOUDevicePushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiDeleteIOUDevicePushButton = QtWidgets.QPushButton(parent=self.widget)
