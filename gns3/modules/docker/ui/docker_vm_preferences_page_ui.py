...
class Ui_DockerVMPreferencesPageWidget(object):
    def setupUi(self, DockerVMPreferencesPageWidget):
        ...
        self.uiDockerVMInfoTreeWidget = QtWidgets.QTreeWidget(parent=self.widget)
        ...
        self.uiNewDockerVMPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiCopyDockerVMPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiEditDockerVMPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiDeleteDockerVMPushButton = QtWidgets.QPushButton(parent=self.widget)
