...
class Ui_IOSRouterPreferencesPageWidget(object):
    def setupUi(self, IOSRouterPreferencesPageWidget):
        ...
        self.uiIOSRouterInfoTreeWidget = QtWidgets.QTreeWidget(parent=self.widget)
        ...
        self.uiNewIOSRouterPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiDecompressIOSPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiCopyIOSRouterPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiEditIOSRouterPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiDeleteIOSRouterPushButton = QtWidgets.QPushButton(parent=self.widget)
