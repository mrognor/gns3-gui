...
class Ui_QemuVMPreferencesPageWidget(object):
    def setupUi(self, QemuVMPreferencesPageWidget):
        ...
        self.uiQemuVMInfoTreeWidget = QtWidgets.QTreeWidget(parent=self.widget)
        ...
        self.uiNewQemuVMPushButton = QtWidgets.QPushButton(parent=self.widget)
        self.uiNewQemuVMPushButton.setObjectName("uiNewQemuVMPushButton")
        self.horizontalLayout.addWidget(self.uiNewQemuVMPushButton)
        self.uiCopyQemuVMPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiEditQemuVMPushButton = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.uiDeleteQemuVMPushButton = QtWidgets.QPushButton(parent=self.widget)
